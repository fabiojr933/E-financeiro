    ...
    <div class="container-fluid">
      <div class="card">
        <div class="card-footer clearfix">
          <a href="<?php echo URL_BASE ?>cartoes/novo" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Novo</a>
        </div>
                ...
                <?php foreach ($listaCartoes as $cartoes) { ?>
                  <tr>
                    ...
                    <td class="d-flex justify-content-end"> <!-- Alinha as ações à direita -->
                      ...
                      <button type="button" onclick="document.getElementById('id_cartoes').value = '<?php echo  $cartoes->id ?>'" data-toggle="modal" data-target="#modal-default" class="btn btn-danger btn-sm me-1"><i class="fas fa-trash-alt"></i></button>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo URL_BASE ?>cartoes/excluir" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="id_cartoes" name="id" value="" />
                </div>
