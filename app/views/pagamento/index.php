                ...
                <?php foreach ($listaPagamento as $pagamento) { ?>
                  <tr>
                    ...
                    <td class="d-flex justify-content-end"> <!-- Alinha as ações à direita -->
                      <a href="<?php echo URL_BASE . "pagamento/editar/" . $pagamento->id ?>" class="btn btn-success btn-sm me-1">
                        <i class="fas fa-edit"></i>
                      </a>
                      <button type="button" onclick="document.getElementById('id_pagamento').value = '<?php echo  $pagamento->id ?>'" data-toggle="modal" data-target="#modal-default" class="btn btn-danger btn-sm me-1"><i class="fas fa-trash-alt"></i></button>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?php echo URL_BASE ?>pagamento/excluir" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="id_pagamento" name="id" value="" />
                </div>
